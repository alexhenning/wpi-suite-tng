...
/**
 * Creates a backlog tab if not yet created and Switches to the tab
 *
 * @author vpatara
 */
@SuppressWarnings("serial")
public class ListBacklogsAction extends AbstractAction {

	private final MainTabController controller;

	/**
	 * Create a CreateBacklogAction
	 * @param controller When the action is performed, controller.addCreateDefectTab() is called
	 */
	public ListBacklogsAction(MainTabController controller) {
		super("View Backlogs");

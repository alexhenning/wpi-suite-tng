...
public class GetSingleRequirementController implements ActionListener {
	...
	private final RequirementsPanel reqPanel;
	
	/**
	 * Default constructor
	 * @param panel The panel containing all the GUI elements necessary for creation
	 */
	public GetSingleRequirementController(ListRequirementsPanel panel, RequirementPanel reqPanel) {
		this.panel = panel;

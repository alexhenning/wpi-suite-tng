...
public class RetrieveReleaseNumbersRequestObserver implements RequestObserver {
	
	private ReleaseNumberCallback callback;
	
	public RetrieveReleaseNumbersRequestObserver(ReleaseNumberCallback callback) {
	...
	public void responseSuccess(IRequest iReq) {
		...
		final ReleaseNumber[] reqs = ReleaseNumber.fromJSONArray(response.getBody());
	...
	public void responseError(IRequest iReq) {
		System.err.println("The request to retrieve ReleaseNumbers failed.");	
	}
